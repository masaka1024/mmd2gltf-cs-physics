...
### スカート統計の比較基準 (順序決定化後・2026-08-08)
以降のスカート傾き比較はこの値を基準とする (IA.pmx, 30Hz・1サブ, 60ステップ暖機,
ボーン空間, ターン窓は|下半身ヨー|>360°/s)。順序決定化により、無関係な剛体を足しても
この値は一致する (ノイズフロア≈0)。

| | 中央 | p90 | max |
|---|---|---|---|
| 平時 | 11.041 | 22.498 | 111.822 |

| 窓 | 開始F | peakYaw | frame-max傾き |
|---|---|---|---|
| 1 | 848 | 671 | 87.861 |
| 2 | 1169 | -364 | 43.697 |
| 3 | 1850 | 443 | 46.886 |
