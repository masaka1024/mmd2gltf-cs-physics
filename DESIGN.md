...
### スカート統計の比較基準 (実効1/60=SubSteps2・2026-08-08)
以降のスカート傾き比較はこの値を基準とする (IA.pmx, **FixedTimeStep=1/30・SubSteps=2 (実効1/60)**,
反復10, 60ステップ暖機, ボーン空間, ターン窓は|下半身ヨー|>360°/s)。ノイズフロア≈0
(遠方ダミー剛体の有無で完全一致・実測)。本家 平時中央=11.39。

| | 中央 | p90 | max |
|---|---|---|---|
| 平時 | 10.459 | 21.215 | 85.781 |

リング別 平時中央: ring0=9.63 / ring1=11.62 / ring2=10.66。貫入 平均=0.0318 / 最大=2.152。
性能 IA.pmx 300ステップ: avg=0.65 / p95=0.71 / max=0.99 ms。**12窓比の中央値=1.030** (本家1.0)。

| 窓 | 開始F | peakYaw | 自前 frame-max | 本家 max | 比 |
|---|---|---|---|---|---|
| 1 | 848 | 671 | 66.71 | 57.30 | 1.164 |
| 2 | 1169 | -364 | 38.86 | 44.20 | 0.879 |
| 3 | 1850 | 443 | 47.99 | 43.52 | 1.103 |
| 4 | 1963 | -542 | 65.79 | 59.12 | 1.113 |
| 5 | 2316 | -410 | 41.22 | 41.54 | 0.992 |
| 6 | 2435 | -431 | 61.90 | 62.91 | 0.984 |
| 7 | 4013 | 465 | 58.37 | 53.98 | 1.081 |
| 8 | 4123 | -539 | 58.89 | 52.31 | 1.126 |
| 9 | 4476 | -435 | 48.20 | 51.49 | 0.936 |
| 10 | 4592 | -467 | 49.86 | 50.79 | 0.982 |
| 11 | 5915 | -422 | 46.37 | 45.88 | 1.011 |
| 12 | 6034 | -477 | 54.69 | 52.09 | 1.050 |
