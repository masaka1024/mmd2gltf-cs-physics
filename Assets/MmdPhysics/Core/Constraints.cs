...
namespace BulletPhysics
{
    ...
    public sealed class Joint
    {
        ...
        ///   - 採用ゲート全通過: bonecheck ビット不変 (モデルA はばね0) /
        ...
        //   実測: モデルC は spring=100000 に対し錘の質量 0.01 で
        ...
        //   モデルA のジョイントがばね定数ゼロだったため（＝1モデルでの検証は安定性を保証しない）。
        //
        ...
        //   実測A/B(300step 全剛体姿勢ハッシュ): モデルA系3モデルはビット完全一致、モデルC は NaN→完走。
