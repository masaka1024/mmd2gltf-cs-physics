...
性能 IA.pmx 300ステップ: avg=0.65 / p95=0.74 / max=0.84 ms。**12窓比の中央値=1.061** (MMD1.0)。
...
### 刻み掃引の実測（反復10固定・IA.pmx・12窓比の中央値, MMD=1.0目標）
...
- IA.pmx で 平時中央値 11.05→13.09、窓の(自前/MMD)傾きmax比の中央値 1.12→1.5 と悪化。
